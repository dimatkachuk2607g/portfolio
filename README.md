...
- **Core projects:** `Python`, `OOP Python`, `Selenium`, `Playwright`, `API Testing` — focused on **Python (basic and advanced), Pytest automation, API testing, and automation frameworks**,  
  also including **basic GitHub Actions integration** for running tests and generating reports.  
